...
<div class="contenido py-3" >
    <br>
        <h2 style="text-align: center;"> Editar Concepto  </h2>
        <hr>
        ...
        <form action="{{ url('terminos/'.$termino->id) }}" method="POST" enctype="multipart/form-data"> <!-- PARA SUBIRDATOS DE TIPO FILE NECESITAMOS USAR enctype="multipart/form-data" -->
        ...
        <div class="row mb-4" style="text-align:center;">
            ...
            <div class="col-sm-4 mt-10">
                <input type="text" name="concepto" id="concepto" class="form-control"  value="{{ $termino->nombre }} " required>
                <br>
            </div>
        </div>
       ...
       <!-- <div class="row mt-4 mb-6" style="">
        ...
        <div class="row mt-4 mb-6" style="">
            ...
            <div class="col-sm-4 ">
                <textarea class="block w-full rounded-md border-gray-300 bg-white shadow-sm transition-colors duration-300 focus:ring-opacity-50 dark:bg-gray-600 dark:bg-gray-800 dark:text-white dark:focus:border-indigo-300 dark:focus:ring dark:focus:ring-indigo-200 dark:focus:ring-opacity-50" 
                placeholder="" name="descripcion" id="descripcion" cols="50" rows="5">{{ $termino->definicion }}</textarea>
                <br>
            </div>
        </div>
        ...
        <br>
            ...
            <div class="col-sm-4 mt-4">
                <input type="file" name="imagen" id="imagen" class="form-control" value=" {{ $termino->imagen }} " required>
            </div>
        </div>   
        ...
        <br> <br>
            <button type="submit" class="btn btn-success btn-sm">Actualizar concepto</button>
